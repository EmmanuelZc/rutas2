...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $txtID_parada = $_POST['txtID_parada'] ?? "1";
        ...
        case "Agregar":
            try {
                ...
                if ($sentenciaSQL->execute()) {
                    echo "<script>alert('✅ Ruta  " . htmlspecialchars($txtruta, ENT_QUOTES, 'UTF-8') . " agregada correctamente');</script>";
                } else {
...
<h2 class="text-center text-primary mb-4 border-bottom pb-2">Registro de Ruta</h2>
    ...
    <div class="col-md-6 d-flex align-items-center">
        ...
        <input type="hidden" class="form-control w-50" name="txtID_parada" id="txtID_parada" value="1" min="1">
    </div>

    <div class="col-md-6 d-flex align-items-center">
        <label for="txtruta" class="me-2">Nombre de la Ruta:</label>
        <input type="text" class="form-control w-75" name="txtruta" id="txtruta" placeholder="Nombre de la Ruta">
    </div>
</div>
