    ...
    <div class="logo" style="position: absolute; top: 0; right: 0; padding: 10px;">
    <img src="administrador/images/logo.png" alt="Logo de la Empresa" class="img-fluid" style="max-width: 150px; height: auto;">
</div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($usuarios[$usuario]) && $usuarios[$usuario] === $contrasena) {
        ...
        $url = "https://localhost/sitioweb/administrador/seccion/rutas.php?";
